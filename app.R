            ...
            tagList(
              tabBox(title = strong("Box Plot", style = "color:black"), width = NULL,
                     tabPanel("Phylum", align = "center",
                              plotOutput("box_1", height = num_box[1]*250, width = 750),
                     )
                     ,
                     tabPanel("Class", align = "center",
                              plotOutput("box_2", height = num_box[2]*250, width = 750),
                     )
                     ,tabPanel("Order", align = "center",
                               plotOutput("box_3", height = num_box[3]*250, width = 750),
                     )
                     ,tabPanel("Family", align = "center",
                               plotOutput("box_4", height = num_box[4]*250, width = 750),
                     )
                     ,tabPanel("Genus", align = "center",
                               plotOutput("box_5", height = num_box[5]*250, width = 750),
                     )
                     ,tabPanel("Species", align = "center",
                               plotOutput("box_6", height = num_box[6]*250, width = 750),
                     )
              )
            )
          })
