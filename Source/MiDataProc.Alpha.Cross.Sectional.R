...
biom.cleanS <- function(biom, rem.tax = rem.tax.d, rem.tax.str = rem.tax.str.d, kingdom = "Bacteria", tax.tab.c = TRUE, lib.size.cut.off = 3000, mean.prop.cut.off = 2e-05, surv.time, censor, follow, subgroup.var = NULL, subgroup = NULL) {
  ...
  sam.dat  <- sam.follow.time.func(sam.dat, surv.time, censor, as.numeric(follow))
